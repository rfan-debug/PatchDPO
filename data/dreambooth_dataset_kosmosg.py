...
# Copy from the GitHub repository of Kosmos-G, which selects only one image for each entity
selected_imgs = {
    "pink_sunglasses": "04",
    "can": "01",
    "candle": "02",
...
class DreamboothDatasetKosmosg(torch.utils.data.Dataset):
    def __init__(self, data_root, tokenizer, size=512):
        ...
        for key in self.all_entities:
            ...
            for cur_entity in cur_entities:
                ...
                entity_img_names = [selected_imgs[entity_dir_name]] # Select only one image for each entity
